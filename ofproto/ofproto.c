    ...
    OVS_EXCLUDED(ofproto_mutex)
{
    ...
    RULE_COLLECTION_FOR_EACH (rule, &rules) {
        ...
        VLOG_INFO("++++++++++xyh handle_flow_stats_request: match->wc.masks.value[0][0]=%d match->wc.masks.value[0][7]=%d match->wc.masks.value[0][8]=%d",fs.match.wc.masks.value[0][0],fs.match.wc.masks.value[0][7],fs.match.wc.masks.value[0][8]);
    ...
    OVS_EXCLUDED(ofproto_mutex)
{
    ...
    case OFPTYPE_FLOW_MOD:
    	VLOG_INFO("+++++++++++xyh handle_openflow__: OFPTYPE_FLOW_MOD");
    ...
    case OFPTYPE_BARRIER_REQUEST:
    	VLOG_INFO("+++++++++++xyh handle_openflow__: OFPTYPE_BARRIER_REQUEST");
    ...
    case OFPTYPE_FLOW_STATS_REQUEST:
    	VLOG_INFO("+++++++++++xyh handle_openflow__: OFPTYPE_FLOW_STATS_REQUEST");
